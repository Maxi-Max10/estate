                            ...
                            <div class="space-y-6 lg:space-y-0 lg:flex lg:items-start lg:gap-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="collapse show lg:!block" id="adminMenuOps">
                                        <a class="block py-2 text-amber-300 text-lg lg:text-sm lg:font-medium lg:py-1 lg:inline-flex lg:items-center lg:gap-2 lg:rounded-full lg:bg-white/10 lg:px-3 lg:py-2 lg:text-white" href="fincas-admin.php">Fincas</a>
                                    </div>
                                </div>
                            </div>
